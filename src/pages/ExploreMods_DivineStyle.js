...
function ExploreMods({ onBackToHome }) {
  ...
  }, [mods, searchTerm, freeOnly, paidOnly, selectedCategories, selectedThemes, selectedFeatures, selectedColors, selectedChampions]);
  ...
  const features = [
    "Animations", "Model", "Visual Effects", "Sound Effects", "Voice Over"
  ];

  const colors = [
    "Black", "White", "Red", "Blue", "Green", "Yellow", "Purple", "Orange", "Other"
  ];
